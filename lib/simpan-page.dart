...
class _SimpanPageState extends State<SimpanPage> {
  ...
  Future savePresensi(latitude, longitude) async {
    ...
    var response = await myHttp.post(
        Uri.parse("https://attendanceadmin10.000webhostapp.com/api/save-presensi"),
        body: body,
        headers: headers);
              ...
              return SafeArea(
                ...
                children: [
                  ...
                  onPressed: () async {
                    ...
                    // Then, save the data
                    LocationData? locationData = await _currenctLocation();
                    if (locationData != null) {
                      savePresensi(locationData.latitude, locationData.longitude);
                    }
                  },
