...
import 'package:presensi/faceModule/face_detector_painter.dart';
import 'utils.dart';
    ...
    try {
      ...
      _camera!.startImageStream((CameraImage image) async {
        try {
          ...
          print("Error in startImageStream: $e");
        }
      });
    } catch (e) {
      print("Error initializing camera: $e");
      // Handle initialization error, show an error message, etc.
    }
  }
                      ...
                      ElevatedButton(
                        ...
                        style: ButtonStyle(
                          ...
                          minimumSize: MaterialStateProperty.all<Size>(
                              const Size(80, 30)), // Adjust the Size as needed
                        ),
