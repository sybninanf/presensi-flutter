...
import 'package:presensi/faceModule/utils.dart';
...
Future<tfl.Interpreter?> loadModel() async {
  try {
    ...
    return await tfl.Interpreter.fromAsset('mobilefacenet.tflite', options: interpreterOptions);
  } on Exception {
...
HandleDetection getDetectionMethod() {
  // Detect whether a face is present or not
