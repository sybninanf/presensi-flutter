import 'dart:convert';
import 'package:presensi/faceModule/face_recognition.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future getData() async {
    ...
    var response = await myHttp.get(
        Uri.parse('https://attendanceadmin10.000webhostapp.com/api/get-presensi'),
        headers: headres);
  ...
  onPressed: () async {
    // Fetch the list of cameras before navigating to FaceNetApp
    // List<CameraDescription>? cameras = await availableCameras();

    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => FaceRecognitionView()))
        .then((value) {
        if (value == true) {
